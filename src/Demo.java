...
public class Demo {
    ...
    public void  start() {
        ...
        filteredBooks = bs.filterBooksByAuthor(author, books);
        filteredBooks = bs.filterBooksAfterSpecifiedYear(1990 , books);
        filteredBooks = bs.filterBooksByPublisher(publisher , books);
    }
